...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-us" className="relative overflow-hidden bg-[#050505] py-24 md:py-32">
      ...
      Transform your body with ALBO Fitness. Experience expert trainers, personalized workout plans, nutrition coaching, and a motivating environment built for real progress.
          </p>
        </header>
