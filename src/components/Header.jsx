  ...
  return (
      ...
      <nav className="max-w-7xl mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/calculator" className="text-gray-300 hover:text-white font-medium transition-colors">
            Calculator
          </Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-gray-900 border-t border-gray-800">
          <div className="flex flex-col p-4 space-y-3 max-w-7xl mx-auto">
            ...
            <Link to="/calculator" className="py-2 text-gray-300 hover:text-white transition-colors">
              Calculator
            </Link>
